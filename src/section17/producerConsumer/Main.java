package section17.producerConsumer;
...
import static section17.producerConsumer.Main.EOF;
    ...
    public static void main(String[] args) {
        ...
        Future<String> future = executorService.submit(new Callable<String>() {
            ...
            public String call() throws Exception {
                System.out.println(ThreadColor.ANSI_RED+"I am being printed for Callable class");
