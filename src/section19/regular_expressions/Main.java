...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String telephoneRegExp = "^([\\(]{1}[0-9]{3}[\\)]{1}[ ]{1}[0-9]{3}[\\-]{1}[0-9]{4})$";
        String phone1 = "1234567890";
        String phone2 = "(123) 456-7890";
        String phone3 = "123 456-7890";
        String phone4 = "(123)456-7890";

        System.out.println("phone1 = "+phone1.matches(telephoneRegExp));
        System.out.println("phone2 = "+phone2.matches(telephoneRegExp));
        System.out.println("phone3 = "+phone3.matches(telephoneRegExp));
        System.out.println("phone4 = "+phone4.matches(telephoneRegExp));

        // ^4[0-9]{12}([0-9]{3})?$
        String visaRegExp = "^4[0-9]{12}([0-9]{3})?$";
        String visa1 = "4444444444444";
        String visa2 = "5444444444444";
        String visa3 = "44444444444444444";
        String visa4 = "4444";

        System.out.println("visa1 = "+visa1.matches(visaRegExp));
        System.out.println("visa2 = "+visa2.matches(visaRegExp));
